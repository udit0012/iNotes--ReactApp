...
const Auth = () => {
    ...
    return <div className='w-full h-full lg:w-5/6 bg-slate-100 flex flex-col items-center justify-start py-24'>
        <div className="lg:hidden text-4xl px-3 py-2 md:px-6 md:py-4 text-green-700 font-serif">
            <div className='flex'>
        ...
        <div className="md:max-w-3xl w-11/12 lg:max-w-2xl bg-white shadow-lg flex flex-col items-center py-2">
            <div className='w-5/6 flex bg-green-200 rounded-full my-2 text-xl font-serif'>
